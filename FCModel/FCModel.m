...
+ (void)openDatabaseAtPath:(NSString *)path key:(NSString *)key withSchemaBuilder:(void (^)(FMDatabase *db, int *schemaVersion))schemaBuilder { [self openDatabaseAtPath:path key:key withDatabaseInitializer:nil schemaBuilder:schemaBuilder]; }
